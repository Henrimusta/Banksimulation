...
public:
    ...
    void setupUi(QDialog *DLLwithdraw)
    {
        ...
        DLLwithdraw->resize(1124, 765);
        label = new QLabel(DLLwithdraw);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(30, 130, 121, 31));
        QFont font;
        font.setPointSize(16);
        label->setFont(font);
        groupBox = new QGroupBox(DLLwithdraw);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(30, 190, 411, 461));
        QFont font1;
        ...
        creditBalanceLine->setGeometry(QRect(710, 220, 91, 20));
